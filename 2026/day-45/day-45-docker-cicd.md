...
[Docker-Hub](https://hub.docker.com/repository/docker/arvindjitendrapatil/webapp/general)
...
6. Run the container: `docker run -d --name mywebapp -p 9090:80 arvindjitendrapatil/webapp:latest`
